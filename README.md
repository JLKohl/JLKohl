...
### Disney Planner (Personal Project)

Authenticated backend web application with Google OAuth login and protected API access.

- Passport.js Google authentication
- Session-based route protection
- Swagger API documentation
- Deployed backend application on Render

GitHub Repository:
https://github.com/JLKohl/cse341-personal-project
